...
public class Level1 extends Level {
	public Level1(GameplayState state, LevelSave model){	
		...
		//herbe liÈs aux sols 1 2 et 3
		Wall w1 = createWall(0,Global.GAMEPLAYHEIGHT-90,80,50); // bois au dessus pour Èviter le bug
		w1.setImage("newherbe2.png");
		w1.image = w1.image.getSubImage(0,15,80,50);
		Wall w2 = createWall(310,Global.GAMEPLAYHEIGHT-90,100,50); // bois au dessus pour Èviter le bug
		w2.setImage("newherbe2.png");
		w2.image = w2.image.getSubImage(0,15,100,50);
		Wall w3 = createWall(Global.GAMEPLAYWIDTH-80,Global.GAMEPLAYHEIGHT-50,80,50); // bois au dessus pour Èviter le bug
