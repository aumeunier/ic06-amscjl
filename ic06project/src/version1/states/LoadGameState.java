...
/**
 * The LoadGameState is used to load a previously saved game.
 * A simple click on a name will load the given save and will return the game to the main menu.
 *
 */
