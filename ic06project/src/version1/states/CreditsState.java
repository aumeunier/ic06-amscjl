...
/**
 * This is the Credits' screen. The credits are in three parts:
 * 		conception and realisation (the three of us),
 * 		graphisms (Clement and the reuse-free graphisms found on the Internet),
 * 		musics (reuse-free, found on the Internet)
 *
 */
